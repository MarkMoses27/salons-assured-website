    ...
    <main className="overflow-hidden bg-[#f7f4f0]">
          ...
          >
            <div className="relative min-h-[570px] overflow-hidden rounded-t-[15rem] rounded-b-[2rem] border border-white/15 bg-white/[0.05] shadow-[0_45px_140px_rgba(0,0,0,0.42)] sm:min-h-[680px]">
              <Image
                ...
                alt="Beauty business training and professional event"
                fill
                priority
      ...
      >
        <div className="mx-auto max-w-[1400px] px-5 sm:px-8 lg:px-10">
          <Reveal className="grid gap-8 border-b border-[#d8d0c9] pb-8 sm:grid-cols-[1fr_auto] sm:items-end">
            <div>
              <SectionLabel>Next Salons Assured Experience</SectionLabel>
          ...
          <div className="grid border-b border-[#d8d0c9] lg:grid-cols-[0.38fr_1.1fr_0.72fr]">
            {/* DATE */}
            <Reveal className="border-b border-[#d8d0c9] py-10 lg:border-b-0 lg:border-r lg:pr-9">
            ...
            >
              <div className="relative min-h-[500px] overflow-hidden rounded-[1rem] sm:min-h-[630px]">
                <Image
                  src="/hero-slide-2.png"
                  alt="Salons Assured beauty business growth event"
                  fill
      ...
      <section className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-[1400px] px-5 sm:px-8 lg:px-10">
          <Reveal className="grid gap-10 border-b border-[#ead5db] pb-12 lg:grid-cols-[1fr_0.7fr] lg:items-end">
            <div>
              <SectionLabel>Our Event Experiences</SectionLabel>
            ...
            {eventFormats.map((event, index) => {
              ...
              return (
                <motion.article
                  ...
                  className="group grid gap-7 py-11 transition duration-300 hover:bg-[#fbf4f6]/55 sm:grid-cols-[75px_70px_0.9fr_1.1fr_45px] sm:items-center sm:px-5"
                >
      ...
      <section className="relative overflow-hidden bg-[#d9a3af] py-24 sm:py-32">
        <div className="absolute -right-44 top-0 h-[520px] w-[520px] rounded-full border border-[#071b33]/10" />
      ...
      <section className="bg-[#071b33] py-24 text-white sm:py-32">
        <div className="mx-auto max-w-[1400px] px-5 sm:px-8 lg:px-10">
          <Reveal className="grid gap-10 border-b border-white/15 pb-12 lg:grid-cols-[1fr_0.7fr] lg:items-end">
            <div>
              <SectionLabel light>Inside the Experience</SectionLabel>
            ...
            <p className="max-w-xl text-[16px] leading-8 text-white/60 lg:justify-self-end">
              These are temporary photographs. Replace them later
              with real Salons Assured event photography using the
              same filenames.
            </p>
          </Reveal>
          ...
          <div className="mt-14 grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
            <Reveal>
              <div className="relative min-h-[650px] overflow-hidden rounded-[1.4rem]">
                <Image
                  src="/hero-slide-3.png"
                  alt="Beauty business training experience"
                  fill
            ...
            <div className="grid gap-5">
              <Reveal delay={0.08}>
                <div className="relative min-h-[310px] overflow-hidden rounded-[1.4rem]">
                  <Image
                    src="/hero-slide-2.png"
                    alt="Beauty industry networking"
                    fill
              ...
              <Reveal delay={0.16}>
                <div className="relative min-h-[320px] overflow-hidden rounded-[1.4rem]">
                  <Image
                    src="/why-choose-us.png"
                    alt="Beauty business discussion"
                    fill
                    sizes="(max-width: 1024px) 100vw, 42vw"
                    className="object-cover transition duration-1000 hover:scale-[1.04]"
                  />
      ...
      <section className="relative overflow-hidden bg-white py-24 sm:py-32">
        <div className="mx-auto grid max-w-[1400px] gap-14 px-5 sm:px-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:px-10">
          <Reveal>
            <div className="relative min-h-[560px] overflow-hidden rounded-[1.5rem] sm:min-h-[680px]">
              <Image
                src="/why-choose-us.png"
                alt="Private beauty business training session"
                fill
          ...
          <Reveal delay={0.12}>
            <SectionLabel>Private Business Experiences</SectionLabel>
      ...
      <section className="relative overflow-hidden bg-[#071b33] py-28 text-white sm:py-36">
        ...
        <Reveal className="relative mx-auto max-w-[1150px] px-5 text-center sm:px-8">
          ...
          <Link
            href="/contact"
            className="group mt-10 inline-flex h-15 items-center justify-center gap-3 rounded-full bg-[#d9a3af] px-10 py-4 text-sm font-extrabold text-[#071b33] shadow-[0_22px_70px_rgba(217,163,175,0.22)] transition duration-300 hover:-translate-y-1 hover:bg-white"
          >
            Join the Priority List
