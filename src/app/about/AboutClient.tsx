...
const overviewItems = [
  {
    value: "1",
    label: "Specialist Industry",
    detail: "Beauty, wellness and professional grooming",
  },
  {
    value: "6",
    label: "Connected Pillars",
    detail: "From recruitment and systems to setup and growth",
  },
  {
    value: "3",
    label: "Growth Pathways",
    detail: "Owners, investors and beauty professionals",
  },
  {
    value: "360°",
    label: "Business View",
    detail: "People, operations, clients and performance",
  },
];
...
const directionItems: DirectionItem[] = [
  {
    number: "01",
    label: "Our Mission",
    title: "To strengthen the business behind every beauty service.",
    description:
  ...
  },
  {
    number: "02",
    label: "Our Vision",
    title: "A more structured, trusted and investable beauty industry.",
    description:
  ...
  },
  {
    number: "03",
    label: "Our Promise",
    title: "Advice that moves beyond discussion into implementation.",
    description:
...
const workAreas: WorkArea[] = [
  {
    number: "01",
    label: "Operations",
    title: "Operational onboarding and management support",
    description:
  ...
  },
  {
    number: "02",
    label: "Assessment",
    title: "Business and team assessments",
    description:
  ...
  },
  {
    number: "03",
    label: "People",
    title: "Recruitment, interviews and onboarding",
    description:
  ...
  },
  {
    number: "05",
    label: "Launch",
    title: "Setup and launch-readiness support",
    description:
  ...
  },
  {
    number: "06",
    label: "Growth",
    title: "Management and visibility support",
    description:
...
const socialLinks = [
  {
    number: "01",
    label: "Facebook",
    note: "Business updates, industry conversations and community activity",
    href: "https://www.facebook.com/salonsassuredkenya/",
  },
  {
    number: "02",
    label: "Instagram",
    note: "Beauty-business insights, events, training and behind-the-scenes work",
    href: "https://www.instagram.com/salonsassured/",
  },
  {
    number: "03",
    label: "TikTok",
    note: "Short-form industry guidance and practical business conversations",
    href: "https://www.tiktok.com/@salonsassuredkenya",
  },
  {
    number: "04",
    label: "Google Location",
    note: "Kwaheri Road, Runda, Nairobi",
...
function SectionLabel({
  ...
  return (
    <div className="flex items-center gap-4">
      <span
        className={["h-px w-10", light ? "bg-[#d9a3af]" : "bg-[#b87586]"].join(
          " ",
        )}
      />
...
export default function AboutClient() {
  ...
  return (
    <main id="top" className="overflow-hidden bg-white text-[#071b33]">
      {/* HERO */}
      <section className="relative isolate min-h-[860px] overflow-hidden bg-[#071b33] text-white">
        ...
        <div className="relative mx-auto grid min-h-[860px] max-w-[1380px] gap-14 px-5 pb-20 pt-36 sm:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:px-10 lg:pb-24 lg:pt-32">
          ...
          >
            <SectionLabel light>About Salons Assured</SectionLabel>
            ...
            <p className="mt-8 max-w-[690px] text-[16px] leading-8 text-white/72 sm:text-[18px]">
              Salons Assured Kenya is a specialist beauty-business growth
              partner. We strengthen the people, systems, service standards and
              decisions behind salons, spas, barbershops, studios and beauty
              ventures.
            </p>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-x-5 gap-y-3 border-t border-white/15 pt-7">
              {["People", "Systems", "Service", "Growth"].map((item, index) => (
            ...
            <div className="relative min-h-[560px] overflow-hidden rounded-t-[14rem] rounded-b-[2rem] border border-white/15 bg-white/[0.06] shadow-[0_45px_140px_rgba(0,0,0,0.42)] sm:min-h-[680px]">
              ...
              <div className="absolute inset-x-0 bottom-0 p-7 sm:p-10">
                ...
                <p className="mt-4 max-w-lg [font-family:var(--font-display)] text-[32px] font-semibold leading-[0.98] tracking-[-0.045em] text-white sm:text-[42px]">
                  Beauty expertise supported by serious business structure.
                </p>
              </div>
            </div>
      ...
      >
        ...
        <div className="relative mx-auto grid max-w-[1380px] gap-14 px-5 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:px-10">
          <Reveal className="relative">
            <div className="group relative aspect-[3/2] overflow-hidden rounded-[2rem] bg-[#071b33] shadow-[0_35px_100px_rgba(7,27,51,0.18)]">
              <Image
                src="/sak-community-group.webp"
                alt="Salons Assured community and beauty business professionals at an industry event"
                fill
                unoptimized
              ...
              <div className="absolute inset-x-0 bottom-0 p-7 text-white sm:p-10">
                ...
                <p className="mt-5 max-w-[600px] [font-family:var(--font-display)] text-[32px] font-semibold italic leading-[1] tracking-[-0.04em] sm:text-[43px]">
                  Talent delivers the service. Structure builds the business.
                </p>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.08} className="lg:pl-8">
            ...
            <div className="mt-8 max-w-[720px] space-y-6 text-[15px] leading-8 text-[#071b33]/65">
              <p>
                The beauty industry contains exceptional technical talent.
                However, talent alone does not define roles, manage performance,
                control stock, retain clients, build management discipline or
                create sustainable growth.
              </p>

              <p>
                Salons Assured exists to close that gap. We bring a structured
                business perspective to an industry that is often forced to grow
                through experience, pressure and costly mistakes.
              </p>

              <p>
                Our role is to help owners, investors, managers and
                professionals understand the whole business, make better
                decisions and put practical structures behind their ambitions.
              </p>
            </div>
      ...
      {/* CLIENT PARTNERSHIP */}
      <section className="relative overflow-hidden bg-[#f8f5f3] py-20 sm:py-24 lg:py-28">
        <div className="pointer-events-none absolute -left-56 -bottom-56 h-[560px] w-[560px] rounded-full border border-[#b87586]/10" />

        <div className="relative mx-auto grid max-w-[1380px] gap-14 px-5 sm:px-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:px-10">
          <Reveal className="lg:pr-8">
            <SectionLabel>Client Partnership</SectionLabel>

            <h2 className="mt-7 max-w-[760px] [font-family:var(--font-display)] text-[47px] font-semibold leading-[0.93] tracking-[-0.054em] sm:text-[64px] lg:text-[73px]">
            ...
            <div className="mt-8 max-w-[700px] space-y-6 text-[15px] leading-8 text-[#071b33]/65">
              <p>
                Every beauty business has its own team, customer, service and
                operational realities. We begin by understanding those realities
                before recommending the right response.
              </p>

              <p>
                Our role may involve assessment, staffing, team development,
                management support, documentation, launch readiness or a
                connected programme combining several areas.
              </p>
            </div>
            ...
            <div className="mt-9 grid gap-4 sm:grid-cols-3">
              {[
                ...
                <div
                  key={item.number}
                  className="border border-[#071b33]/10 bg-white p-5"
                >
                  <p className="[font-family:var(--font-display)] text-[25px] font-semibold italic text-[#b87586]">
                    {item.number}
                  </p>

                  <p className="mt-4 text-[9px] font-extrabold uppercase tracking-[0.18em] text-[#071b33]/68">
                    {item.title}
                  </p>
                </div>
              ))}
          ...
          <Reveal delay={0.08} className="relative">
            <div className="group relative aspect-[3/2] overflow-hidden rounded-[2rem] bg-[#071b33] shadow-[0_35px_100px_rgba(7,27,51,0.18)]">
              <Image
                src="/sak-client-partnership.webp"
                alt="Salons Assured supporting a client team inside a barbershop and spa"
                fill
                unoptimized
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#071b33]/82 via-transparent to-transparent" />
              ...
              <div className="absolute inset-x-0 bottom-0 p-7 text-white sm:p-9">
                ...
                <p className="mt-4 max-w-[650px] [font-family:var(--font-display)] text-[31px] font-semibold leading-[1] tracking-[-0.04em] sm:text-[40px]">
                  Practical support shaped around the people and operations
      ...
      <section className="relative overflow-hidden bg-white py-20 sm:py-24 lg:py-28">
        ...
        <div className="relative mx-auto grid max-w-[1380px] gap-14 px-5 sm:px-8 lg:grid-cols-[0.82fr_1.18fr] lg:items-center lg:px-10">
          <Reveal className="relative">
            <div className="group relative mx-auto min-h-[600px] max-w-[560px] overflow-hidden rounded-t-[14rem] rounded-b-[1.5rem] bg-[#071b33] shadow-[0_35px_100px_rgba(7,27,51,0.2)] sm:min-h-[720px]">
              <Image
                src="/sak-leadership-portrait.webp"
                alt="Salons Assured leadership representative at a professional industry event"
                fill
                unoptimized
              ...
              <div className="absolute inset-x-0 bottom-0 p-7 text-white sm:p-9">
                ...
                <p className="mt-4 [font-family:var(--font-display)] text-[32px] font-semibold leading-[0.98] tracking-[-0.04em] sm:text-[42px]">
                  Industry knowledge translated into practical business
                  direction.
                </p>
              </div>
            </div>
          ...
          <Reveal delay={0.1} className="lg:pl-8">
            ...
            <h2 className="mt-7 max-w-[820px] [font-family:var(--font-display)] text-[47px] font-semibold leading-[0.92] tracking-[-0.054em] sm:text-[65px] lg:text-[76px]">
            ...
            <div className="mt-8 max-w-[720px] space-y-6 text-[15px] leading-8 text-[#071b33]/64">
              <p>
                Salons Assured combines beauty-industry understanding with
                practical business management. This allows our work to respond
                to the realities of service businesses while introducing the
                structure required for growth.
              </p>

              <p>
                Our approach is collaborative. We work with owners, managers,
                teams, investors and professionals to understand the situation
                before recommending the next action.
              </p>

              <p>
                The objective is not to impose theory. It is to help clients
                make clearer decisions, develop stronger people and build
                operations that perform consistently.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  text: "Understanding the service, people and client realities of beauty businesses.",
                },
                {
                  number: "02",
                  title: "Business Discipline",
                  text: "Introducing practical structures, standards and accountability.",
                },
                {
                  number: "03",
                  title: "Implementation",
                  text: "Turning recommendations into clear actions, tools and routines.",
                },
              ].map((item, index) => (
                <motion.article
                  key={item.number}
                  ...
                  className="border border-[#071b33]/10 bg-[#f8f5f3] p-6"
                >
                  <p className="[font-family:var(--font-display)] text-[27px] font-semibold italic text-[#b87586]">
                    {item.number}
                  </p>

                  <h3 className="mt-6 [font-family:var(--font-display)] text-[27px] font-semibold leading-[0.98] tracking-[-0.035em]">
                    {item.title}
                  </h3>

                  <p className="mt-4 text-[11px] leading-6 text-[#071b33]/55">
                    {item.text}
                  </p>
                </motion.article>
              ))}
      ...
      <section className="relative overflow-hidden bg-[#071b33] py-20 text-white sm:py-24 lg:py-28">
        ...
        <div className="relative mx-auto max-w-[1380px] px-5 sm:px-8 lg:px-10">
          <Reveal className="grid gap-9 border-b border-white/15 pb-11 lg:grid-cols-[1fr_390px] lg:items-end">
            <div>
              <SectionLabel light>The SAK Business Model</SectionLabel>
            ...
            <p className="text-[14px] leading-8 text-white/65">
              A business may begin with one immediate need, but stronger results
              come from understanding how its people, operations, service,
              visibility and leadership affect one another.
            </p>
          </Reveal>
        ...
        <div className="mx-auto max-w-[1380px] px-5 sm:px-8 lg:px-10">
          <Reveal className="grid gap-9 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
            ...
            <p className="max-w-[670px] text-[15px] leading-8 text-[#071b33]/62 lg:justify-self-end">
              Our work is guided by a clear belief: a stronger beauty industry
              creates better businesses, more sustainable careers and more
                ...
                >
                  ...
                  <p
                    className={[
                      ...
                      index === 1 ? "text-[#071b33]/60" : "text-[#b87586]",
                    ].join(" ")}
                  >
                    {item.label}
                  </p>
                  ...
                  <p
                    className={[
                      ...
                      index === 1 ? "text-[#071b33]/68" : "text-[#071b33]/58",
                    ].join(" ")}
                  >
                    {item.description}
                  </p>
        ...
        <div className="mx-auto max-w-[1380px] px-5 sm:px-8 lg:px-10">
          <Reveal className="grid gap-10 border-b border-[#071b33]/10 pb-12 lg:grid-cols-[1fr_380px] lg:items-end">
            ...
            <p className="text-[14px] leading-8 text-[#071b33]/62">
              We do not begin with a predetermined package. We begin by
              understanding the business and building the right pathway forward.
            </p>
          </Reveal>
      ...
      <section className="relative overflow-hidden bg-[#d9a3af] py-20 sm:py-24 lg:py-28">
        ...
        <div className="relative mx-auto max-w-[1380px] px-5 sm:px-8 lg:px-10">
          <Reveal className="grid gap-9 lg:grid-cols-[1fr_380px] lg:items-end">
            <div>
              <SectionLabel>Work in Action</SectionLabel>
            ...
            <p className="text-[14px] leading-8 text-[#071b33]/68">
              Our assignments involve operational onboarding, assessments,
              recruitment, launch readiness, team training, documentation and
              management support.
            </p>
          </Reveal>
          ...
          <Reveal className="mt-14">
            <div className="group relative aspect-[3/2] overflow-hidden rounded-[2rem] bg-[#071b33] shadow-[0_30px_90px_rgba(7,27,51,0.18)]">
              <Image
                src="/sak-consultation-in-action.webp"
                alt="Salons Assured professionals discussing practical business support during a consultation"
                fill
                unoptimized
              ...
              <div className="absolute inset-x-0 bottom-0 p-7 text-white sm:p-10">
                ...
                <p className="mt-4 max-w-[760px] [font-family:var(--font-display)] text-[31px] font-semibold leading-[1] tracking-[-0.04em] sm:text-[42px]">
                  Listening, diagnosing and building practical next steps with
          ...
          <div className="mt-8 overflow-hidden border-y border-[#071b33]/15 bg-white">
          ...
          <p className="mt-7 max-w-[760px] text-[11px] leading-6 text-[#071b33]/62">
            Client names and detailed outcomes are published through approved
            case studies where permission for public use has been confirmed.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white py-20 sm:py-24 lg:py-28">
        <div className="mx-auto max-w-[1380px] px-5 sm:px-8 lg:px-10">
          <Reveal className="max-w-[930px]">
            <SectionLabel>The Beauty Ecosystem</SectionLabel>
              ...
              return (
                <Reveal
                  ...
                  className={[
                    ...
                    index > 0 ? "lg:border-l-0" : "",
                    index === 1 ? "bg-[#071b33] text-white" : "bg-[#f8f5f3]",
                  ].join(" ")}
                >
                  ...
                  <div className="relative z-10 flex items-start justify-between">
                    <span
                      className={[
                        ...
                        index === 1 ? "text-[#d9a3af]" : "text-[#b87586]",
                      ].join(" ")}
                    >
                      {audience.number}
                    </span>
                  ...
                  <p
                    className={[
                      ...
                      index === 1 ? "text-white/62" : "text-[#071b33]/60",
                    ].join(" ")}
                  >
                  ...
                  <Link
                    ...
                    className={[
                      ...
                      index === 1 ? "text-white" : "text-[#071b33]",
                    ].join(" ")}
                  >
                    {audience.action}
        ...
        <div className="mx-auto grid max-w-[1380px] gap-14 px-5 sm:px-8 lg:grid-cols-[0.38fr_0.62fr] lg:px-10">
          <Reveal className="lg:sticky lg:top-32 lg:self-start">
            ...
            <p className="mt-7 max-w-[430px] text-[14px] leading-8 text-[#071b33]/62">
              The quality of our advice matters, but so does the way we
              communicate, implement and remain accountable to the client.
            </p>
          ...
          <div className="border-y border-[#071b33]/10 bg-white">
            {values.map((value, index) => (
              <Reveal key={value.number} delay={index * 0.04}>
        ...
        <div className="relative mx-auto max-w-[1380px] px-5 sm:px-8 lg:px-10">
          <Reveal className="grid gap-12 lg:grid-cols-[0.82fr_1.18fr] lg:items-stretch">
            <div className="flex flex-col justify-between border border-white/15 bg-white/[0.04] p-7 sm:p-10">
              <div>
                <SectionLabel light>Our Base</SectionLabel>
                ...
                <p className="mt-7 max-w-[520px] text-[14px] leading-8 text-white/65">
                  From our base in Runda, we support beauty businesses,
                  investors and professionals through on-site, virtual and
      ...
      <section className="relative overflow-hidden bg-[#d9a3af] py-20 text-[#071b33] sm:py-24">
        ...
        <div className="relative mx-auto grid max-w-[1380px] gap-10 px-5 sm:px-8 lg:grid-cols-[1fr_330px] lg:items-end lg:px-10">
          ...
          <Reveal delay={0.08} className="border-l border-[#071b33]/20 pl-6">
            <p className="text-[14px] leading-8 text-[#071b33]/68">
              Speak with our team about recruitment, training, systems, setup,
              operations or beauty-business growth.
            </p>
